							...
							<div class="card-body">
								<div class="float-right">
									<div class="section-header-button">
										<button class="btn btn-primary shadow" data-toggle="modal" data-target="#modal-konsentrasi">Tambah
											Konsentrasi</button>
									</div>
								</div>
...
<form class="modal-part" id="modal-konsentrasi" method="POST" action="">
		...
		<div class="float-left">
			...
			@foreach ($formulas->Material as $material)
				<div class="input-group">
					<input type="text" class="form-control mb-2" value="{{ $material->name }}">
				</div>
			@endforeach
		</div>
	</div>
	<div class="form-group">
		<div class="float-right">
			...
			@foreach ($formulas->Material as $material)
				<div class="input-group">
					<input type="number" class="form-control mb-2" value="{{ $material->pivot->concentration }}">
				</div>
			@endforeach
