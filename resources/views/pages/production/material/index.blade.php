								...
								<div class="float-left">
									<div class="section-header-button">
										<a href="{{ route('material.create') }}" class="btn btn-primary">Add New
											Material</a>
										<button class="btn btn-success shadow" data-toggle="modal" data-target="#modal-material">Import Material
										</button>
									</div>
								</div>
											...
											<tr>
												...
												<td>
													<div class="d-flex justify-content-center">
														<a href='{{ route('material.edit', $material->id) }}' class="btn btn-sm btn-success">
															<i class="fas fa-edit"></i>
															Edit
														</a>

														<form action="{{ route('material.destroy', $material->id) }}" method="POST" class="ml-2">
