...
let sidebar = document.getElementById("menuan");

// Menambah atau menghapus kelas "open" untuk menampilkan/menyembunyikan sidebar
function toggleSidebar() {
    sidebar.classList.toggle("open");
}

// Menutup sidebar setelah menu diklik
